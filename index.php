  ...
  <div class="slider" style="width: 60%; margin: auto;">
    <ul class="slides">
      ...
      <li>
        ...
        <div class="caption center-align">
          <h3 class="bold page-title">Welcome to E-commerce platform</h3>
          <h5 class="bold page-title">From pc to peripherals, we got u covered.</h5>
          <h5 class="bold page-title">At Tech pc</h5>
        </div>
      </li>
      <li>
      ...
      <li>
        ...
        <div class="caption center-align">
          <h3 class="bold green-text page-title">Enjoy our services</h3>
        </div>
      </li>
      <li>
