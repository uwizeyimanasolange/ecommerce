        ...
        <div class="row">
          <div class="col s4">   
            <a class="magnifier-thumb-wrapper demo">
              <img id="thumb" style="max-height: 350px; width: 200px; margin-top: 30px" src="product_images/<?php echo($image); ?>"
              data-large-img-url="product_images/<?php echo($image); ?>"
              data-large-img-wrapper="preview">
            </a>
            <div class="magnifier-preview example heading" id="preview" style="width: 500px; height:450px"></div>
          </div>
          <div class="col s8">
            <div class="row">
